...
public partial class cms_admin_QuangCao_QuanLyNhomQuangCao_NhomQuangCao_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = HiPhucShop.NhomQuangCao.Thongtin_Nhomquangcao_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            HiPhucShop.NhomQuangCao.Nhomquangcao_Inser(tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName, "");
        ...
        else
        {
            ...
            HiPhucShop.NhomQuangCao.Nhomquangcao_Update(id, tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName);

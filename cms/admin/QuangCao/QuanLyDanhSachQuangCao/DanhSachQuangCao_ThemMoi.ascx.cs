...
public partial class cms_admin_QuangCao_QuanLyDanhSachQuangCao_DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if(thaotac=="ChinhSua")
        {
            ...
            dt = HiPhucShop.QuangCao.Thongtin_Quangcao_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.NhomQuangCao.Thongtin_Nhomquangcao();
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            HiPhucShop.QuangCao.Quangcao_Inser(
        ...
        else
        {
            ...
            HiPhucShop.QuangCao.Quangcao_Update(

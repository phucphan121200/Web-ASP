...
public partial class cms_admin_TinTuc_DanhMucTin_DanhMucTin_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = HiPhucShop.DanhMucTin.Thongtin_DanhmucTin_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.DanhMucTin.Thongtin_DanhmucTin_by_MaDMCha("0");
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.DanhMucTin.Thongtin_DanhmucTin_by_MaDMCha(MaDMCha);
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            HiPhucShop.DanhMucTin.DanhmucTin_Inser(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
        ...
        else
        {
            ...
            HiPhucShop.DanhMucTin.DanhmucTin_Update(id, tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue);

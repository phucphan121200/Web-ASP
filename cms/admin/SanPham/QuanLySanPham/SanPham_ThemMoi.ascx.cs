...
public partial class cms_admin_SanPham_QuanLySanPham_SanPham_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if(thaotac=="ChinhSua")
        {
            ...
            dt = HiPhucShop.SanPham.Thongtin_Sanpham_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.NhomSanPham.Thongtin_Nhomsp();
        ddlNhom.Items.Clear();
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.DanhMuc.Thongtin_Danhmuc_by_MaDMCha("0");
    ...
    {
        DataTable dt = new DataTable();
        dt = HiPhucShop.DanhMuc.Thongtin_Danhmuc_by_MaDMCha(MaDMCha);
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            HiPhucShop.SanPham.Sanpham_Inser(tbTenSanPham.Text, flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text, tbNgayTao.Text, tbNgayHuy.Text, ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
        ...
        else
        {
            ...
            HiPhucShop.SanPham.Sanpham_Update(id,tbTenSanPham.Text, tenAnhDaiDien, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text,

...
public partial class cms_admin_SanPham_QuanLyPhienDauGia_PhienDauGia_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = HiPhucShop.PhienDauGia.Thongtin_PhienDauGia_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            HiPhucShop.PhienDauGia.PhienDauGia_Inser(tbThoiGianBatDau.Text,tbThoiGianKetThuc.Text,tbMaSP.Text,tbGiaDeXuat.Text,"");
        ...
        else
        {
            ...
            HiPhucShop.PhienDauGia.PhienDauGia_Update(id, tbThoiGianBatDau.Text,tbThoiGianKetThuc.Text,tbMaSP.Text,tbGiaDeXuat.Text);

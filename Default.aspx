...
<head runat="server">
    <title>Cửa hàng phân phối uy tín và chất lượng  </title>
...
<body>
            ...
            <div id="timkiem">
                ...
                <div class="timkiemphai">
                    ...
                    <div class="hotline">
                        ...
                        <div class="number">0944.707.505 - 0942.266.661</div>
                    </div>
                    <div class="otimkiem">
                        <div class="search">
                            <div id="searchForm">
        ...
        <div class="contener">
            <div id="trangtrai">
                ...
                <div id="hotro">
                   <div id="pichotro">
                        <div class="logohotro">
                            <img src="css/images/hotro.jpg" title="pichtro" />
                        </div>
                    ...
                    <div class="support">
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Hoàng Phúc</span>
                                <br />                    
                                <span class="phone">0942.266.661</span>
                            </p>                    
                        </div>
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Nhựt Anh</span>
                                <br />
                                <span class="phone">0944.707.505</span>
                            </p>                            
                        </div>
                        <div class="text-center">
                            <p>
    ...
    <div id="footer">
        <div class="contener">
            <div class=" menufoter">
                <p>©2020 Copyright by HiPhucShop</p>
            </div>
        </div>
    </div>
    </form>

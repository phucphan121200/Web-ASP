...
public partial class _Default : System.Web.UI.Page
{
    ...
    private string LayMenu()
    {
        string s = "";
        DataTable dt = new DataTable();
        dt = HiPhucShop.Menu.Thongtin_Menu_by_MaMenuCha("0");
        for (int i = 0; i < dt.Rows.Count; i++)
        {
    ...
    private string LayBanner()
    {
        ...
        DataTable dt = new DataTable();
        dt = HiPhucShop.NhomQuangCao.Thongtin_Nhomquangcao_by_vitriqc("banner");
...
<a href='" + lienKet + @"' title='" + dt.Rows[0]["TenQC"] + @"'>
    ...
    private string LayLogo()
    {
        ...
        //Code lấy ra vị trí quảng nhóm cáo
        DataTable dt = new DataTable();
        dt = HiPhucShop.NhomQuangCao.Thongtin_Nhomquangcao_by_vitriqc("logo");
